...
class Hamburger {
  ...
  calculatePrice() {
    ...
    return calculatePrice + priceStuffings + priceToppings;
  ...
  calculateCalories() {
    ...
    let caloriesStuffings = Hamburger.STUFFINGS[this._stuffing].calories;
    let caloriesToppings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].calories + acc, 0);
    return calculateCalories + caloriesStuffings + caloriesToppings;
  }
}
